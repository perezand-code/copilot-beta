...
public class DirectedGraphTest {
    ...
    public void testFindPath() {
        ...
        System.out.printf("g1(A,  B) path: %s%n", SampleGraphs.g1().findPath("A","B"));
        System.out.printf("g2(A,  E) path: %s%n", SampleGraphs.g2().findPath("A", "E"));
        System.out.printf("g3(A,A10) path: %s%n", SampleGraphs.g3().findPath("A", "A10"));
        System.out.printf("g4(A,  F) path: %s%n", SampleGraphs.g4().findPath("A", "F"));
    }
